...
public class ClosestToOriginFitMaintainPowerOfTwoStrategyTests {
    ...
    public void packOneSprite() throws SizeTooSmallException {
        ...
        strategy.pack(sheet, new Constraints(16, 32, true, false));
    ...
    public void packOneSpriteDoesNotFit() throws SizeTooSmallException {
        ...
        strategy.pack(sheet, new Constraints(2, 8, true, false));
    }
    ...
    public void packTwoSprites() throws SizeTooSmallException {
        ...
        strategy.pack(sheet, new Constraints(128, 128, true, false));
