...
/**
 * Tests the implementation of HighestFitMaintainAspectRatioStrategy.
 */
public class HighestFitMaintainAspectRatioStrategyTests {

    HighestFitMaintainAspectRatioStrategy strategy;
